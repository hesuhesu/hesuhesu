...
<!-- 아이콘 총 모음 -->
[![My Skills](https://skillicons.dev/icons?i=svelte,threejs,js,ts,sqlite,spring,webpack,react,raspberrypi,qt,py,opencv,npm,nodejs,mysql,linux,bootstrap,kotlin,jquery,java,html,gradle,github,git,fastapi,django,css,cpp,c,arduino)](https://skillicons.dev)
